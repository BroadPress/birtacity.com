...
const Prachalitsection = () => {
	return (
		<div className="mt-10 flex flex-col gap-10 ">
			...
			<div className="lg:flex-row flex flex-col-reverse gap-8 lg:h-[290px]">
				{/* LEFT SIDE */}
				<div className="flex flex-col lg:w-1/2 gap-6 h-full">
					{[image1, image2].map((img, index) => (
						<div
							key={index}
							className="lg:flex-row flex flex-col gap-4 lg:h-[50%]"
						>
							<img
								src={img}
								alt=""
							...
							/>
							<div className="flex flex-col gap-2 justify-around lg:w-1/2 line-clamp-1 ">
								<p className="font-bold">
									युवाहरूलाई इन्टरनेटमार्फत स्वरोजगारमा जोड्न सकिनेछ...
								</p>
								<p className="text-md text-justify line-clamp-2">
